    ...
    <div className="relative max-w-4xl mx-auto px-4">
      ...
      >
        ...
        >
          ...
          <div className="relative space-y-6">
            ...
            <p className="text-base md:text-lg text-white/60 leading-relaxed">
              ...
              <span className="text-white font-medium">collect your data</span><span className="font-bold">,</span>{" "}
              <span className="text-white font-medium">build candidate databases</span><span className="font-bold">,</span> or{" "}
              <span className="text-white font-medium">make companies appear to be growing</span><span className="font-bold">.</span>
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 leading-tight text-center">
            <span className="text-white">
              The Job Board{" "}
            </span>
            <span className="text-white">
          ...
          <p className="text-lg md:text-xl text-white/70 leading-relaxed mb-8 text-center max-w-3xl mx-auto">
            The two major job boards — LinkedIn and Indeed — dominate the market but leave job seekers without the tools they need.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {/* LinkedIn Problems */}
            <div className="bg-gradient-to-br from-white/[0.08] to-white/[0.04] backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="h-6 w-6 text-blue-400">
              ...
              <ul className="space-y-3 text-white/70 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span><span className="text-rose-400 font-semibold">27.4%</span> of job listings are ghost jobs with no intent to hire</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-400 mt-1">•</span>
                  <span><span className="text-amber-400 font-semibold">70%</span> of all ghost jobs are posted on LinkedIn</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-violet-400 mt-1">•</span>
                  <span>Limited filtering options leave users sifting through thousands of irrelevant results</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-cyan-400 mt-1">•</span>
                  <span>Recruiter InMails have less than <span className="text-cyan-400 font-semibold">1%</span> response rate due to spam</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-white/[0.08] to-white/[0.04] backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="h-6 w-6 text-blue-400">
                    <path fill="currentColor" d="M11.49 17.32c-.83 0-1.5-.67-1.5-1.5V9.14c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v6.68c0 .83-.67 1.5-1.5 1.5zm0-12.32c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5z"/>
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-white">Indeed</h3>
              </div>
              <ul className="space-y-3 text-white/70 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-rose-400 mt-1">•</span>
                  <span><span className="text-rose-400 font-semibold">49%</span> of ghost jobs appear on Indeed</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-400 mt-1">•</span>
                  <span>Scraped listings often contain <span className="text-amber-400 font-semibold">inaccurate</span> salary, location, and job details</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-violet-400 mt-1">•</span>
                  <span>Expired jobs remain listed—&quot;posting date&quot; shows when scraped, not when originally posted</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-cyan-400 mt-1">•</span>
                  <span>Direct company applications have <span className="text-cyan-400 font-semibold">4x higher</span> success rate than job board applications</span>
                </li>
              </ul>
            </div>
          </div>

          <p className="text-base md:text-lg text-white/50 leading-relaxed max-w-3xl mx-auto text-center mt-8">
            Meanwhile, <span className="text-white/70 font-medium">65% of positions</span> are filled without ever being posted publicly — and the ones that are posted often lack the filters you need to find what you&apos;re actually looking for.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <p className="text-base md:text-lg text-white leading-relaxed max-w-3xl mx-auto font-medium text-center">
