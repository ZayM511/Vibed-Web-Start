...
export default function JobDatabasePage() {
  ...
  // Admin view - show reviews database
  if (!organizedReviews) {
    return (
      <>
        <HeaderNav />
      ...
      <div className="relative min-h-screen w-full overflow-hidden bg-background pt-16">
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <Badge variant="outline" className="bg-indigo-500/20 text-indigo-300 border-indigo-400/30">
              Admin View Only
            </Badge>
            <div className="flex items-center justify-center gap-6 text-white/60 mt-6">
