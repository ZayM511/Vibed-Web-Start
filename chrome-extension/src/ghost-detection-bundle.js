...
(function () {
  ...
  // Community-reported companies database — synced with content script REPORTED_COMPANIES_CARD (122 companies)
  // Keys are normalized with all spaces stripped to match normalizeCompanyForLookup()
  const COMMUNITY_REPORTED_DB = {
    // Scam companies (risk: 1.0)
    'hiremefast': { category: 'scam', risk: 1.0 },
    'hiremefastllc': { category: 'scam', risk: 1.0 },
    'swooped': { category: 'scam', risk: 1.0 },
    'techietalent': { category: 'scam', risk: 1.0 },
    // Spam aggregators (risk: 0.9)
    'dice': { category: 'spam', risk: 0.9 },
    'dicecom': { category: 'spam', risk: 0.9 },
    'talentifyio': { category: 'spam', risk: 0.9 },
    'talentify': { category: 'spam', risk: 0.9 },
    // Ghost posting companies (risk: 0.8)
    'abbvie': { category: 'ghost', risk: 0.8 },
    'accenture': { category: 'ghost', risk: 0.8 },
    'accruent': { category: 'ghost', risk: 0.8 },
    'aecom': { category: 'ghost', risk: 0.8 },
    'affinipay': { category: 'ghost', risk: 0.8 },
    'ageoflearning': { category: 'ghost', risk: 0.8 },
    'aha': { category: 'ghost', risk: 0.8 },
    'apotex': { category: 'ghost', risk: 0.8 },
    'arrowstreetcapital': { category: 'ghost', risk: 0.8 },
    'ascendion': { category: 'ghost', risk: 0.8 },
    'assigncorp': { category: 'ghost', risk: 0.8 },
    'atlashealth': { category: 'ghost', risk: 0.8 },
    'atlassian': { category: 'ghost', risk: 0.8 },
    'ayahealthcare': { category: 'ghost', risk: 0.8 },
    'balfourbeatty': { category: 'ghost', risk: 0.8 },
    'balfourbeaty': { category: 'ghost', risk: 0.8 },
    'bankofamerica': { category: 'ghost', risk: 0.8 },
    'bofa': { category: 'ghost', risk: 0.8 },
    'beyondtrust': { category: 'ghost', risk: 0.8 },
    'biorender': { category: 'ghost', risk: 0.8 },
    'bobsled': { category: 'ghost', risk: 0.8 },
    'booksource': { category: 'ghost', risk: 0.8 },
    'bostonscientific': { category: 'ghost', risk: 0.8 },
    'burtintelligence': { category: 'ghost', risk: 0.8 },
    'businesswire': { category: 'ghost', risk: 0.8 },
    'caci': { category: 'ghost', risk: 0.8 },
    'caesars': { category: 'ghost', risk: 0.8 },
    'caesarsentertainment': { category: 'ghost', risk: 0.8 },
    'cardinalhealth': { category: 'ghost', risk: 0.8 },
    'cedarssinai': { category: 'ghost', risk: 0.8 },
    'chenmed': { category: 'ghost', risk: 0.8 },
    'clari': { category: 'ghost', risk: 0.8 },
    'clearwater': { category: 'ghost', risk: 0.8 },
    'clearwateranalytics': { category: 'ghost', risk: 0.8 },
    'clover': { category: 'ghost', risk: 0.8 },
    'codeandtheory': { category: 'ghost', risk: 0.8 },
    'comcast': { category: 'ghost', risk: 0.8 },
    'contra': { category: 'ghost', risk: 0.8 },
    'cotiviti': { category: 'ghost', risk: 0.8 },
    'creditacceptance': { category: 'ghost', risk: 0.8 },
    'crocs': { category: 'ghost', risk: 0.8 },
    'crossover': { category: 'ghost', risk: 0.8 },
    'cvs': { category: 'ghost', risk: 0.8 },
    'cvshealth': { category: 'ghost', risk: 0.8 },
    'cvspharmacy': { category: 'ghost', risk: 0.8 },
    'dcbl': { category: 'ghost', risk: 0.8 },
    'doordash': { category: 'ghost', risk: 0.8 },
    'earnin': { category: 'ghost', risk: 0.8 },
    'embraer': { category: 'ghost', risk: 0.8 },
    'evidation': { category: 'ghost', risk: 0.8 },
    'excellenceservices': { category: 'ghost', risk: 0.8 },
    'ey': { category: 'ghost', risk: 0.8 },
    'ernstyoung': { category: 'ghost', risk: 0.8 },
    'fanatics': { category: 'ghost', risk: 0.8 },
    'filescom': { category: 'ghost', risk: 0.8 },
    'fiserve': { category: 'ghost', risk: 0.8 },
    'fiserv': { category: 'ghost', risk: 0.8 },
    'floqast': { category: 'ghost', risk: 0.8 },
    'fluency': { category: 'ghost', risk: 0.8 },
    'fluentstream': { category: 'ghost', risk: 0.8 },
    'gehealthcare': { category: 'ghost', risk: 0.8 },
    'gehealth': { category: 'ghost', risk: 0.8 },
    'generalelectrichealthcare': { category: 'ghost', risk: 0.8 },
    'genworth': { category: 'ghost', risk: 0.8 },
    'goldenhippo': { category: 'ghost', risk: 0.8 },
    'goodrx': { category: 'ghost', risk: 0.8 },
    'greendot': { category: 'ghost', risk: 0.8 },
    'harborfreighttools': { category: 'ghost', risk: 0.8 },
    'harborfreight': { category: 'ghost', risk: 0.8 },
    'healthedge': { category: 'ghost', risk: 0.8 },
    'hubspot': { category: 'ghost', risk: 0.8 },
    'jpmorganchase': { category: 'ghost', risk: 0.8 },
    'jpmorgan': { category: 'ghost', risk: 0.8 },
    'chase': { category: 'ghost', risk: 0.8 },
    'kforce': { category: 'ghost', risk: 0.8 },
    'kingshawaiian': { category: 'ghost', risk: 0.8 },
    'klaviyo': { category: 'ghost', risk: 0.8 },
    'kraftkennedy': { category: 'ghost', risk: 0.8 },
    'leidos': { category: 'ghost', risk: 0.8 },
    'lumenalta': { category: 'ghost', risk: 0.8 },
    'magistrate': { category: 'ghost', risk: 0.8 },
    'mandai': { category: 'ghost', risk: 0.8 },
    'matterport': { category: 'ghost', risk: 0.8 },
    'medix': { category: 'ghost', risk: 0.8 },
    'molinahealth': { category: 'ghost', risk: 0.8 },
    'molinahealthcare': { category: 'ghost', risk: 0.8 },
    'motionrecruitment': { category: 'ghost', risk: 0.8 },
    'mozilla': { category: 'ghost', risk: 0.8 },
    'nbcnews': { category: 'ghost', risk: 0.8 },
    'nbcuniversal': { category: 'ghost', risk: 0.8 },
    'nv5': { category: 'ghost', risk: 0.8 },
    'oneforma': { category: 'ghost', risk: 0.8 },
    'onetrust': { category: 'ghost', risk: 0.8 },
    'origin': { category: 'ghost', risk: 0.8 },
    'oscarhealth': { category: 'ghost', risk: 0.8 },
    'paradoxai': { category: 'ghost', risk: 0.8 },
    'polly': { category: 'ghost', risk: 0.8 },
    'posit': { category: 'ghost', risk: 0.8 },
    'prizepicks': { category: 'ghost', risk: 0.8 },
    'publicishealth': { category: 'ghost', risk: 0.8 },
    'raptive': { category: 'ghost', risk: 0.8 },
    'resmed': { category: 'ghost', risk: 0.8 },
    'roberthalf': { category: 'ghost', risk: 0.8 },
    'seetec': { category: 'ghost', risk: 0.8 },
    'signifyhealth': { category: 'ghost', risk: 0.8 },
    'smithrx': { category: 'ghost', risk: 0.8 },
    'socaledison': { category: 'ghost', risk: 0.8 },
    'southerncaliforniaedison': { category: 'ghost', risk: 0.8 },
    'sce': { category: 'ghost', risk: 0.8 },
    'socalgas': { category: 'ghost', risk: 0.8 },
    'southerncaliforniagas': { category: 'ghost', risk: 0.8 },
    'softrams': { category: 'ghost', risk: 0.8 },
    'sonder': { category: 'ghost', risk: 0.8 },
    'stickermule': { category: 'ghost', risk: 0.8 },
    'sundaysfordogs': { category: 'ghost', risk: 0.8 },
    'sunnova': { category: 'ghost', risk: 0.8 },
    'tabby': { category: 'ghost', risk: 0.8 },
    'teksystems': { category: 'ghost', risk: 0.8 },
    'terrabis': { category: 'ghost', risk: 0.8 },
    'thermofisher': { category: 'ghost', risk: 0.8 },
    'thermofisherscientific': { category: 'ghost', risk: 0.8 },
    'ticketscom': { category: 'ghost', risk: 0.8 },
    'tixr': { category: 'ghost', risk: 0.8 },
    'toast': { category: 'ghost', risk: 0.8 },
    'uclahealth': { category: 'ghost', risk: 0.8 },
    'uline': { category: 'ghost', risk: 0.8 },
    'underdog': { category: 'ghost', risk: 0.8 },
    'underdogsports': { category: 'ghost', risk: 0.8 },
    'unisys': { category: 'ghost', risk: 0.8 },
    'vertafore': { category: 'ghost', risk: 0.8 },
    'vxi': { category: 'ghost', risk: 0.8 },
    'webstaurant': { category: 'ghost', risk: 0.8 },
    'webstaurantstore': { category: 'ghost', risk: 0.8 },
    'wrike': { category: 'ghost', risk: 0.8 },
    'yahoonews': { category: 'ghost', risk: 0.8 },
    'yahoo': { category: 'ghost', risk: 0.8 },
    '1800packrat': { category: 'ghost', risk: 0.8 },
  };
